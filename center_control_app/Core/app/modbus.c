...
MB_DATA_ADDR_METERING_MODULE_FORMAT,MB_DATA_ADDR_IO_HARDWARE_CTRL,REG_DATA_ADDR_DMX512_LENTH,REG_DATA_ADDR_DMX512_END,
};
...
HoldingCallOut( USHORT usAddress )
{
	...
	else if(usAddress == MB_DATA_ADDR_IO_HARDWARE_CTRL) // IO 控制
	{
		IO_Hardware_Ctrl_All(usRegHoldingBuf[iRegIndex]);
	}
